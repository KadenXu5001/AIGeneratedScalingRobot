...
class HeightSimulator:
    ...
    def forward(self):
        ...
        self.accumulate_sum_exp()

    def backward(self):
        self.compute_log_sum_exp.grad()
        self.accumulate_sum_exp.grad()
    ...
    def reinitialize_robots(self):
        ...
        for sim_idx in range(self.n_sims[None]):
            ...
            self.sum_exp[sim_idx] = 0.0
            self.max_height[sim_idx] = 0.0
    ...
    def hard_reset(self):
        ...
        self.act.fill(0.0)
        self.loss.fill(0.0)
        self.sum_exp.fill(0.0)
        self.max_height.fill(0.0)
